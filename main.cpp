...
void drawObjectToImage(TGAImage &image, Model &model)
{
    for (auto &face : model.faces)
    {
        glm::vec3 &v0 = model.vertices[face.v0 - 1];
        glm::vec3 &v1 = model.vertices.at(face.v1 - 1);
        glm::vec3 &v2 = model.vertices.at(face.v2 - 1);

        glm::vec3 &vn0 = model.normals[face.vn0 - 1];
        glm::vec3 &vn1 = model.normals[face.vn1 - 1];
        glm::vec3 &vn2 = model.normals[face.vn2 - 1];

        glm::vec3 &vt0 = model.textures[face.vt0 - 1];
        glm::vec3 &vt1 = model.textures[face.vt1 - 1];
        glm::vec3 &vt2 = model.textures[face.vt2 - 1];
        ...
        glm::mat4x4 world_pts4 = model_mat * vertices;
...
#endif
        fill_triangle(image, pts, world_pts, vns, model, vt0, vt1, vt2, projection);
    }
}
